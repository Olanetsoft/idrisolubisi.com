...
export type Press = {
  ...
  date: string;
  href: string;
  /** Shown as a small disclosure when coverage is not independent editorial. */
  disclosure?: string;
};
...
export const press: Press[] = [
  ...
  },
  {
    ...
    disclosure: "Brand press",
  },
];

/** Outlets shown in the hero "featured in" strip — independent editorial coverage only. */
export const featuredIn = ["Business Insider Africa", "BusinessDay", "Technext"];
